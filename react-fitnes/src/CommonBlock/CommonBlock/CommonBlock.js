...
export default function CommonBlock() {
    ...
    return <>
            <div className="firstBlock">
                ...
                {user ? <div className='avatar_name'>{user.displayName}</div> : <Link className='link_style' to='/auth'><button type="button" className="firstBlock_head_entry">Войти</button></Link>}
